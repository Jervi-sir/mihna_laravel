              ...
              <div class="course-card">
                ...
                <div id="collapseOne" class="card-collapse collapse" style>
                  <ul>
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture1.1 Introduction to the User Experience Course
                      </p>
                      <div>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture1.2 Exercise: Your first design challenge
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture1.3 How to solve the previous exercise
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture1.5 How to use text layers effectively
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
              ...
              <div class="course-card">
                ...
                <div id="coursefour" class="card-collapse collapse" style>
                  <ul>
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture4.1 Introduction to the User Experience Course
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture4.2 Exercise: Your first design challenge
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture4.3 How to solve the previous exercise
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture4.4 How to solve the previous exercise
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
                    ...
                    <li>
                      <p>
                        <img src="assets/img/icon/play.svg" alt class="me-2">Lecture4.5 How to use text layers effectively
                      </p>
                      <div>
                        <a href="javascript:;">Preview</a>
                        <span>02:53</span>
          ...
          <div class="sidebar-sec">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="video-details">
                    ...
                    <div class="row gx-2">
                      <div class="col-md-6">
                        <a href="course-wishlist.html" class="btn btn-wish w-100">
            ...
            <div class="card include-sec">
              <div class="card-body">
                ...
                <ul>
                  <li>
                    <img src="assets/img/icon/import.svg" class="me-2" alt> 11 hours on-demand video
                  </li>
                  <li>
                    <img src="assets/img/icon/play.svg" class="me-2" alt> 69 downloadable resources
                  </li>
                  <li>
                    <img src="assets/img/icon/key.svg" class="me-2" alt> Full lifetime access
                  </li>
                  <li>
                    <img src="assets/img/icon/mobile.svg" class="me-2" alt> Access on mobile and TV
                  </li>
                  <li>
                    <img src="assets/img/icon/cloud.svg" class="me-2" alt> Assignments
                  </li>
                  <li>
                    <img src="assets/img/icon/teacher.svg" class="me-2" alt> Certificate of Completion
                  </li>
                </ul>
              </div>
            </div>
            <div class="card feature-sec">
              <div class="card-body">
                ...
                <ul>
                  <li>
                    <img src="assets/img/icon/users.svg" class="me-2" alt> Enrolled: <span>32 students</span>
                  </li>
                  <li>
                    <img src="assets/img/icon/timer.svg" class="me-2" alt> Duration: <span>20 hours</span>
                  </li>
                  <li>
                    <img src="assets/img/icon/chapter.svg" class="me-2" alt> Chapters: <span>15</span>
                  </li>
                  <li>
                    <img src="assets/img/icon/video.svg" class="me-2" alt> Video: <span> 12 hours</span>
                  </li>
                  <li>
                    <img src="assets/img/icon/chart.svg" class="me-2" alt> Level: <span>Beginner</span>
                  </li>
                </ul>
              </div>
            </div>
