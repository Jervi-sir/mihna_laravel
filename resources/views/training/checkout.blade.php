                    ...
                    <div class="col-lg-12">
                      <div class="wallet-method">
                        <label class="radio-inline custom_radio me-4">
                          ...
                          <span class="checkmark"></span> Credit or Debit card </label>
            ...
            <div class="student-widget-group">
              ...
              <div class="benifits-feature">
                ...
                <ul>
                  ...
                  <li>
                    <i class="fas fa-circle"></i> Algorithmic bidding
                  </li>
                  <li>
              ...
              <div class="benifits-feature">
                ...
                <ul>
                  <li>
                    <i class="fas fa-circle"></i> Search term isolation
                  </li>
                  <li>
                    <i class="fas fa-circle"></i> Total sales analytics
                  </li>
                  <li>
                    <i class="fas fa-circle"></i> Best seller rank
                  </li>
                  <li>
