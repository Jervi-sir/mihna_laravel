          ...
          <div class="main-menu-wrapper">
            ...
            <ul class="main-nav">
              <li class="has-submenu">
                <a href>Home <i class="fas fa-chevron-down"></i>
                </a>
                <ul class="submenu">
                  <li>
              ...
              <li class="has-submenu">
                <a href>Instructor <i class="fas fa-chevron-down"></i>
                </a>
                <ul class="submenu">
                  <li>
              ...
              <li class="has-submenu">
                <a href>Student <i class="fas fa-chevron-down"></i>
                </a>
          ...
          <ul class="nav header-navbar-rht">
                      ...
                      <div class="media">
                        <div class="d-flex media-wide">
                          ...
                          <div class="media-body">
                            <h6>
                              <a href="course-details.html">Learn Angular...</a>
                            </h6>
                            <p>By Dave Franco</p>
                            <h5>$200 <span>$99.00</span>
                            </h5>
                          </div>
                        </div>
                    ...
                    <li>
                      <div class="media">
                        <div class="d-flex media-wide">
                          ...
                          <div class="media-body">
                            <h6>
                              <a href="course-details.html">Build Responsive Real...</a>
                            </h6>
                            <p>Jenis R.</p>
                            <h5>$200 <span>$99.00</span>
                            </h5>
                    ...
                    <li>
                      <div class="media">
                        <div class="d-flex media-wide">
                          ...
                          <div class="media-body">
                            <h6>
                              <a href="course-details.html">C# Developers Double ...</a>
                            </h6>
                            <p>Jesse Stevens</p>
                            <h5>$200 <span>$99.00</span>
                            </h5>
            ...
            <li class="nav-item noti-nav">
              ...
              <div class="notifications dropdown-menu dropdown-menu-right">
                <div class="topnav-dropdown-header">
                  <span class="notification-title">Notifications <select>
                      <option>All</option>
                      <option>Unread</option>
                    </select>
                  </span>
                  <a href="javascript:void(0)" class="clear-noti">Mark all as read <i class="fa-solid fa-circle-check"></i>
                  </a>
                </div>
                  ...
                  <ul class="notification-list">
                    <li class="notification-message">
                      <div class="media d-flex">
                        ...
                        <div class="media-body">
                          <h6>
                            <a href="notifications.html">Lex Murphy requested <span>access to</span> UNIX directory tree hierarchy </a>
                          </h6>
                    ...
                    <li class="notification-message">
                      <div class="media d-flex">
                        ...
                        <div class="media-body">
                          <h6>
                            <a href="notifications.html">Ray Arnold left 6 <span>comments on</span> Isla Nublar SOC2 compliance report </a>
                          </h6>
                    ...
                    <li class="notification-message">
                      <div class="media d-flex">
                        ...
                        <div class="media-body">
                          <h6>
                            <a href="notifications.html">Dennis Nedry <span>commented on</span> Isla Nublar SOC2 compliance report </a>
                          </h6>
                    ...
                    <li class="notification-message">
                      <div class="media d-flex">
                        ...
                        <div class="media-body">
                          <h6>
                            <a href="notifications.html">John Hammond <span>created</span> Isla Nublar SOC2 compliance report </a>
                          </h6>
            ...
            <li class="nav-item user-nav">
              ...
              <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                ...
                <a class="dropdown-item" href="setting-edit-profile.html">
                  <i class="feather-user me-1"></i> Profile </a>
                <a class="dropdown-item" href="setting-student-subscription.html">
                  <i class="feather-star me-1"></i> Subscription </a>
                <div class="dropdown-item night-mode">
                  <span>
                    <i class="feather-moon me-1"></i> Night Mode </span>
