...
<div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
    ...
    <p class="mt-10">Already have an account? <a href="{{ route('instructor.login') }}" class="text-purple-1">Log in</a></p>
    ...
    <form class="contact-form respondForm__form row y-gap-20 pt-30" method="POST" action="{{ route('instructor.register') }}">
        ...
        <div class="col-lg-12">
            ...
            <input type="text" placeholder="name" name="name" value="{{ old('name') }}" required autocomplete="Company name" >
        ...
        <div class="col-lg-12">
            ...
            <input type="text" name="phone_number" value="{{ old('phone_number') }}" placeholder="Phone Number" required autofocus autocomplete="phone_number" >
