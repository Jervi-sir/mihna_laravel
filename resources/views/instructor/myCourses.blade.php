                  ...
                  <tr>
                    <td>
                      <div class="sell-table-group d-flex align-items-center">
                        ...
                        <div class="sell-tabel-info">
                          <p>
                            <a href="course-details.html">C# Developers Double Your Coding Speed with Visual Studio</a>
                          </p>
                          <div class="course-info d-flex align-items-center border-bottom-0 pb-0">
                            <div class="rating-img d-flex align-items-center">
                              <img src="assets/img/icon/icon-01.svg" alt>
                  ...
                  <tr>
                    <td>
                      <div class="sell-table-group d-flex align-items-center">
                        ...
                        <div class="sell-tabel-info">
                          <p>
                            <a href="course-details.html">Build Responsive Real World Websites with HTML5 and CSS3</a>
                          </p>
                          <div class="course-info d-flex align-items-center border-bottom-0 pb-0">
                            <div class="rating-img d-flex align-items-center">
                              <img src="assets/img/icon/icon-01.svg" alt>
                    ...
                    <td>0</td>
                    <td>
                      <span class="badge info-high">Deleted</span>
                    </td>
                  </tr>
                </tbody>
              </table>
