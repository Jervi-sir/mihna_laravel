            ...
            <div class="py-30 px-30">
              <form class="contact-form row y-gap-30" action="#">
                ...
                <div class="col-12">
                  ...
                  <textarea id="mytextarea" placeholder="Description" rows="7"></textarea>
                </div>
                <script>
                  tinymce.init({
                    selector: '#mytextarea'
            ...
            <div class="py-30 px-30">
              <div class="row y-gap-50">
                <div class="col-12">
                  <form class="contact-form d-flex lg:flex-column">
                    <div class="relative shrink-0">
                      <img class="w-1/1" src="{{ asset('img/dashboard/media/1.png') }}" alt="image">
                ...
                <div class="col-12">
                  <form class="contact-form d-flex lg:flex-column">
                    <div class="relative shrink-0">
                      <img class="w-1/1" src="{{ asset('img/dashboard/media/2.png') }}" alt="image">
