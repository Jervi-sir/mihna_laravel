      ...
      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
        <div class="tabs -active-purple-2 js-tabs">
          <div class="tabs__controls d-flex items-center pt-20 px-30 border-bottom-light js-tabs-controls">
            ...
            <a href="{{ route('instructor.myFormationsFinished')}}" class="text-light-1 lh-12 tabs__button is-active js-tabs-button ml-30" type="button">
              Finished
            </a>
            <a href="{{ route('instructor.myFormationsAll')}}" class="text-light-1 lh-12 tabs__button js-tabs-button ml-30" type="button">
              All Formations
            </a>
          </div>
