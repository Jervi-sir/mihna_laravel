      ...
      <div class="row">
        <div class="col-md-12 col-12">
          <div class="profile-info-blk">
            ...
            <h4>
              <a href="javascript:;">Gabriel Palmer</a>
              <span>Beginner</span>
            </h4>
            <p>Student</p>
                  ...
                  <div class="course-box course-design d-flex ">
                    <div class="product">
                      ...
                      <div class="product-content">
                        ...
                        <h3 class="title product-content-title">
                      ...
                      <div class="product-content">
                        <div class="course-group d-flex">
                          <div class="course-group-img d-flex">
                            ...
                            <div class="course-name">
                              <h4>
                                <a href="student-profile.html">Jenis R.</a>
                              </h4>
                              <p>Instructor</p>
                            </div>
                          </div>
            ...
            <div class="card-body overview-sec-body">
              ...
              <div class="sidebar-tag-labels">
                <ul class="list-unstyled">
                  <li>
                    <a href="javascript:;" class>User Interface Design</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="javascript:;">Mobile App Design</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="contact-info-list">
                <div class="edu-wrap">
                  <div class="edu-name">
                    <span>
                      <img src="assets/img/instructor/email-icon.png" alt="Address">
                    </span>
                  </div>
                  <div class="edu-detail">
                    <h6>Email</h6>
                    <p>
                      <a href="javascript:;">
                        <span class="__cf_email__" data-cfemail="563c3338382f213f3a25393816332e373b263a337835393b">[email&#160;protected]</span>
                      </a>
                    </p>
                  </div>
                </div>
                <div class="edu-wrap">
                  <div class="edu-name">
                    <span>
                      <img src="assets/img/instructor/address-icon.png" alt="Address">
                    </span>
                  </div>
                  <div class="edu-detail">
                    <h6>Address</h6>
                ...
                <div class="edu-wrap">
                  <div class="edu-name">
                    <span>
                      <img src="assets/img/instructor/phone-icon.png" alt="Address">
                    </span>
                  </div>
                  <div class="edu-detail">
                    <h6>Phone</h6>
